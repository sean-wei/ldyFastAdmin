define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wechat_demo/index' + location.search,
                    add_url: 'wechat_demo/add',
                    edit_url: 'wechat_demo/edit',
                    del_url: 'wechat_demo/del',
                    multi_url: 'wechat_demo/multi',
                    table: 'wechat_demo',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'wechat_demo/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
