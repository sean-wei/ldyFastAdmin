...
<script type="text/javascript">
    ...
    <!--<input type="hidden" id="c-picture" name="row[picture]" value="<?php echo $row['picture']; ?>"/>-->
    <!--<div class="form-group">-->
        <!--<div class="ldypicture-avatar-container">-->
            <!--<img class="ldypicture-picture-img img-responsive img-circle plupload" src="" alt="">-->
            <!--<div class="ldypicture-avatar-text img-thumbnail">编辑模板图片</div>-->
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-picture" data-rule="required" class="form-control" size="50" name="row[picture]" type="text" value="<?php echo htmlentities($row['picture']); ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-tpl" data-rule="required" class="form-control" name="row[tpl]" type="text" value="<?php echo htmlentities($row['tpl']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Uploadtime'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-uploadtime" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[uploadtime]" type="text" value="<?php echo $row['uploadtime']?datetime($row['uploadtime']):''; ?>">
        </div>
    </div>


    <!--<div class="form-group">-->
        <!--<label class="control-label col-xs-12 col-sm-2"><?php echo __('Picture'); ?>:</label>-->
        <!--<div class="col-xs-12 col-sm-8">-->
            <!--<input id="c-picture" data-rule="required" class="form-control" name="row[picture]" type="text" value="<?php echo htmlentities($row['picture']); ?>">-->
        <!--</div>-->
    <!--</div>-->
